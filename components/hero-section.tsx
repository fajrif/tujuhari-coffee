  ...
  return (
    <section id="hero" className="scroll-mt-20 px-5 pb-5 pt-20 lg:px-16 lg:pb-10 lg:pt-24">
      ...
      <div className="lg:hidden">
        ...
        <motion.p
          className="mt-6 font-body text-base leading-relaxed text-brand-ink"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Desktop Banner */}
      <div className="relative hidden aspect-[1397/737] w-full items-end overflow-hidden lg:flex">
        <motion.img
